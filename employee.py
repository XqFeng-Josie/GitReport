#coding=utf-8
from __future__ import print_function#使用高版本的print语法
...
class EmployIssue:
    ...
    def write_2_md(self):
        file_name = 'fe-issue-list.txt'
        f = open(file_name, "w")
        print("#", " issue 周报\n", file == f)
        print("##", "在本周共参与", self.comments_tot, "个 issue \n", file == f)
        for comment in self.comments:
